...
int leeCantidadElem()
{
    ...
    do{
        ...
        if(n<=0)
            cout<<"No seas payas@... ingresa una cantidad correcta: "<<endl;
        if(n>20)
            cout<<"...La cantidad maxima permitida es "<<20<<" : "<<endl;
...
Opciones:
    ...
    cout << endl << "escoge la opcion que mas te convenga: " << endl;
	        ...
	        case 1:
	            {
	                ...
	                do{
	                cout<<"\t >> En que posicion desea insertar...de [0] hasta [" <<cant-1 << "]: "<< endl;
	                cin>>k;
